    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stream', models.CharField(choices=[('hsc', 'HSC'), ('eng', 'Engineering'), ('med', 'Medical'), ('var', 'Varsity')], default='hsc', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chapter', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='progress', to='syllabus.chapter')),
